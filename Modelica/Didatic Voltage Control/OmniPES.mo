  ...
  package WindTurbine
    ...
    equation
      ...
      connect(conversor.outVcc, ctrl_maq.Vccmed) annotation(
        Line(points = {{8, 0}, {8, -10}}, color = {0, 0, 127}));
      ...
      connect(ctrl_maq.Wmed, tac.w) annotation(
        Line(points = {{-14, -20}, {-50, -20}, {-50, 26}}, color = {0, 0, 127}));
      ...
      connect(ctrl_maq.Vqds, voltageSensor.outV) annotation(
        Line(points = {{30, -26}, {70, -26}}, color = {0, 0, 127}, thickness = 0.5));
      ...
      connect(crtl_tur.Wrm_opt, ctrl_maq.Wref) annotation(
        Line(points = {{-14, -26}, {-54, -26}}, color = {0, 0, 127}));
    ...
    package Interfaces
      ...
      record DWTData
        ...
        ConvertedData convData(rs = MVAs / MVAb / Nmaq * rs, rr = MVAs / MVAb / Nmaq * rr, Lls = MVAs / MVAb / Nmaq * Lls, Llr = MVAs / MVAb / Nmaq * Llr, Lm = MVAs / MVAb / Nmaq * Lm, Hm = Nmaq * MVAb / MVAs * Hm, Dm = Nmaq * MVAb / MVAs * Dm, Ht = Nmaq * MVAb / MVAs * Ht, Dt = Nmaq * MVAb / MVAs * Dt, Ktm = Nmaq * MVAb / MVAs * Ktm, Dtm = Nmaq * MVAb / MVAs * Dtm, Ceq = MVAs / MVAb / Nmaq * Ceq, Lc = MVAs / MVAb / Nmaq * Lc);
        annotation(
...
//
      ...
      model CTRL_MAQ
        ...
        Modelica.Blocks.Interfaces.RealInput Vccmed annotation(
          Placement(visible = true, transformation(origin = {-122, -60}, extent = {{-8, -8}, {8, 8}}, rotation = 0), iconTransformation(origin = {0, 90}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        ...
        OmniPES.WindTurbine.CONTROL_model.LIMITER limiter1(maxMod = 1.2) annotation(
        ...
        OmniPES.WindTurbine.CONTROL_model.LIMITER limiter3(maxMod = 1.2) annotation(
          Placement(visible = true, transformation(origin = {-30, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
// Connect Idg:
        ...
        connect(product.y, pi_astrom3.r) annotation(
          Line(points = {{-79, -30}, {-71, -30}}, color = {0, 0, 127}));
        connect(constant1.y, product.u1) annotation(
          Line(points = {{-111, -30}, {-109, -30}, {-109, -24}, {-103, -24}}, color = {0, 0, 127}));
        connect(constant1.y, product.u2) annotation(
          Line(points = {{-111, -30}, {-109, -30}, {-109, -36}, {-103, -36}}, color = {0, 0, 127}));
        connect(Vccmed, product1.u1) annotation(
          Line(points = {{-122, -60}, {-110, -60}, {-110, -54}, {-102, -54}}, color = {0, 0, 127}));
        connect(Vccmed, product1.u2) annotation(
          Line(points = {{-122, -60}, {-110, -60}, {-110, -66}, {-102, -66}}, color = {0, 0, 127}));
...
ASTRÖM")}));
      ...
      model LIMITER
        ...
        Modelica.ComplexBlocks.ComplexMath.RealToComplex u1 annotation(
          Placement(visible = true, transformation(origin = {-62, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.ComplexBlocks.ComplexMath.ComplexToReal y1 annotation(
      ...
      equation
        ...
        absY = absC(y1.u);
        faseY = arg(y1.u);
        connect(u1.re, u[1]) annotation(
          Line(points = {{-74, 6}, {-106, 6}, {-106, 0}}, color = {0, 0, 127}));
        connect(u1.im, u[2]) annotation(
          Line(points = {{-74, -6}, {-106, -6}, {-106, 0}}, color = {0, 0, 127}));
        connect(y1.re, y[1]) annotation(
          Line(points = {{86, 6}, {106, 6}, {106, 0}}, color = {0, 0, 127}));
        connect(y1.im, y[2]) annotation(
          Line(points = {{86, -6}, {106, -6}, {106, 0}}, color = {0, 0, 127}));
        annotation(
