...
//   end when;
  ...
  package WindTurbine
    ...
    model DFIG
      parameter OmniPES.WindTurbine.Interfaces.DWTData smData;
      OmniPES.WindTurbine.DFIG_model.MIT mit(Llr = smData.convData.Llr, Lls = smData.convData.Lls, Lm = smData.convData.Lm, Rr = smData.convData.Rr, Rs = smData.convData.Rs) annotation(
        Placement(visible = true, transformation(origin = {0, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      OmniPES.WindTurbine.TURBINA_model.DUASMASSAS duasmassas(Dtm = smData.convData.Dtm, Hm = smData.convData.Hm, Ht = smData.convData.Ht, Ktm = smData.convData.Ktm)  annotation(
        Placement(visible = true, transformation(origin = {-30, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      OmniPES.WindTurbine.TURBINA_model.EOLICA eolica(N = smData.N, R = smData.R, Sb = 1e6 * smData.MVAb, Wrmb = smData.Wrmb, kb = smData.kb, par = smData.par, tb = smData.tb)  annotation(
        Placement(visible = true, transformation(origin = {-58, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      OmniPES.WindTurbine.CONVERSOR_model.CONVERSOR conversor(Ceq = smData.convData.Ceq)  annotation(
        Placement(visible = true, transformation(origin = {30, -6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      OmniPES.WindTurbine.SENSORS.CurrentSensor currentSensor annotation(
        Placement(visible = true, transformation(origin = {4, -6}, extent = {{4, -4}, {-4, 4}}, rotation = 0)));
      OmniPES.WindTurbine.SENSORS.CurrentSensor currentSensor1 annotation(
        Placement(visible = true, transformation(origin = {52, -6}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
      OmniPES.WindTurbine.CONTROL_model.CTRL_MAQ ctrl_maq(Ceq = smData.convData.Ceq, Idgref = smData.Idgref, Kc = smData.Kc, Lm = smData.convData.Lm, Lr = smData.convData.Llr + smData.convData.Lm, Ls = smData.convData.Lls + smData.convData.Lm, Qgref = smData.Qgref, Vccref = smData.Vccref, kiIdg = smData.kiIdg, kiIdr = smData.kiIdr, kiIqg = smData.kiIqg, kiIqr = smData.kiIqr, kiPLL = smData.kiPLL, kiQs = smData.kiQs, kiVcc = smData.kiVcc, kiWrm = smData.kiWrm, kpIdg = smData.kpIdg, kpIdr = smData.kpIdr, kpIqg = smData.kpIqg, kpIqr = smData.kpIqr, kpPLL = smData.kpPLL, kpVcc = smData.kpVcc, kpWrm = smData.kpWrm)  annotation(
      ...
      OmniPES.WindTurbine.SENSORS.VoltageSensor voltageSensor annotation(
        Placement(visible = true, transformation(origin = {69, -31}, extent = {{-5, -5}, {5, 5}}, rotation = -90)));
      ...
      OmniPES.WindTurbine.CONTROL_model.CRTL_TUR crtl_tur(Vw_max = smData.Vw_max, Vw_min = smData.Vw_min, Vw_nom = smData.Vw_nom, Vw_wmax = smData.Vw_wmax, Vw_wmin = smData.Vw_wmin, Wrm_min = smData.Wrm_min, Wrm_nom = smData.Wrm_nom, fileNameR2 = smData.fileNameR2, fileNameR4 = smData.fileNameR4, tableNameR2 = smData.tableNameR2, tableNameR4 = smData.tableNameR4)  annotation(
        Placement(visible = true, transformation(origin = {-49, -35}, extent = {{-11, -11}, {11, 11}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput Vw annotation(
        Placement(visible = true, transformation(origin = {-84, 14}, extent = {{-6, -6}, {6, 6}}, rotation = 0), iconTransformation(origin = {-110, 4.44089e-16}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  OmniPES.Circuit.Interfaces.PositivePin pin_DFIG annotation(
    ...
    equation
  connect(duasmassas.flange_maq, mit.eixo) annotation(
        Line(points = {{-19, 14}, {0, 14}}));
  connect(currentSensor.pin_n, mit.pin_rotor) annotation(
        Line(points = {{0.4, -6}, {0.4, 8}}));
  connect(currentSensor.pin_p, conversor.outR) annotation(
        Line(points = {{7.6, -6}, {18.6, -6}}));
  connect(conversor.outG, currentSensor1.pin_p) annotation(
        Line(points = {{41.4, -6}, {48, -6}}));
  connect(eolica.flange_Eixo, duasmassas.flange_tur) annotation(
        Line(points = {{-52, 14}, {-41, 14}}));
  ...
  connect(currentSensor.outI, ctrl_maq.Iqdr) annotation(
        Line(points = {{4, -9.6}, {4, -23.6}, {17, -23.6}}, color = {0, 0, 127}, thickness = 0.5));
  connect(ctrl_maq.Iqdg, currentSensor1.outI) annotation(
        Line(points = {{43.2, -23.6}, {52.2, -23.6}, {52.2, -9.6}}, color = {0, 0, 127}, thickness = 0.5));
  connect(mit.pin_estator, powerSensor.pin_p) annotation(
        Line(points = {{11, 14}, {56, 14}}));
  connect(currentSensor1.pin_n, powerSensor.pin_p) annotation(
        Line(points = {{55.6, -6}, {55.2, -6}, {55.2, 14}, {55.6, 14}}));
  connect(ctrl_maq.Qmed, powerSensor.outS[2]) annotation(
        Line(points = {{43.2, -27.2}, {60.2, -27.2}, {60.2, 9.8}}, color = {0, 0, 127}));
  connect(ctrl_maq.Vqds, voltageSensor.outV) annotation(
        Line(points = {{43.2, -30.8}, {52.15, -30.8}, {52.15, -30.6}, {64.9, -30.6}}, color = {0, 0, 127}, thickness = 0.5));
  connect(voltageSensor.pin_p, powerSensor.pin_n) annotation(
        Line(points = {{69, -26.5}, {69, 14}, {64, 14}}));
  connect(duasmassas.flange_maq, tac.flange) annotation(
        Line(points = {{-19, 14}, {-13.5, 14}, {-13.5, -27}, {-6, -27}}));
  connect(tac.w, ctrl_maq.Wmed) annotation(
        Line(points = {{4.5, -27}, {17, -27}}, color = {0, 0, 127}));
  connect(crtl_tur.Wrm_opt, ctrl_maq.Wref) annotation(
        Line(points = {{-36.9, -30.6}, {17.1, -30.6}}, color = {0, 0, 127}));
  connect(eolica.Beta, crtl_tur.beta) annotation(
        Line(points = {{-55.2, 4}, {-49.2, 4}, {-49.2, -25}}, color = {0, 0, 127}));
  connect(Vw, eolica.Vw) annotation(
        Line(points = {{-84, 14}, {-62, 14}}, color = {0, 0, 127}));
  connect(Vw, crtl_tur.Vw) annotation(
        Line(points = {{-84, 14}, {-68, 14}, {-68, -30}, {-62, -30}}, color = {0, 0, 127}));
  connect(pin_DFIG, powerSensor.pin_n) annotation(
        Line(points = {{76, 14}, {64, 14}}, color = {0, 0, 255}));
    protected
      annotation(
        experiment(StartTime = 0, StopTime = 100, Tolerance = 1e-06, Interval = 0.001),
        Diagram(graphics = {Rectangle(origin = {-57, 14}, pattern = LinePattern.Dot, lineThickness = 0.5, extent = {{-9, 22}, {9, -22}}), Rectangle(origin = {-49, -29}, pattern = LinePattern.Dot, lineThickness = 0.5, extent = {{-17, 9}, {17, -9}}), Rectangle(origin = {-30, 14}, pattern = LinePattern.Dot, lineThickness = 0.5, extent = {{-14, 8}, {14, -8}}), Rectangle(origin = {1, 13}, fillColor = {255, 255, 255}, pattern = LinePattern.Dot, lineThickness = 0.5, extent = {{-13, 13}, {13, -13}}), Rectangle(origin = {30, -29}, pattern = LinePattern.Dot, lineThickness = 0.5, extent = {{-18, 9}, {18, -9}}), Rectangle(origin = {30, -6}, pattern = LinePattern.Dot, lineThickness = 0.5, extent = {{-14, 10}, {14, -10}}), Text(origin = {-29, 28}, extent = {{-17, 4}, {17, -4}}, textString = "MODELO
    MECÂNICO"), Text(origin = {0, 30}, extent = {{-12, 2}, {12, -2}}, textString = "MIT"), Text(origin = {-57, 42}, extent = {{-17, 4}, {17, -4}}, textString = "MODELO
    AERODINÂMICO"), Text(origin = {-49, -44}, extent = {{-17, 4}, {17, -4}}, textString = "CONTROLE
    MECÂNICO"), Text(origin = {31, -44}, extent = {{-17, 4}, {17, -4}}, textString = "CONTROLE
    ELÉTRICO"), Text(origin = {29, 8}, extent = {{-9, 2}, {9, -2}}, textString = "CONVERSOR"), Rectangle(origin = {75, 13}, fillColor = {255, 255, 255}, pattern = LinePattern.Dot, lineThickness = 0.5, extent = {{-9, 13}, {9, -13}}), Text(origin = {74, 30}, extent = {{-12, 2}, {12, -2}}, textString = "REDE"), Text(origin = {-84, 28}, extent = {{-12, 2}, {12, -2}}, textString = "VENTO"), Rectangle(origin = {-83, 11}, fillColor = {255, 255, 255}, pattern = LinePattern.Dot, lineThickness = 0.5, extent = {{-9, 13}, {9, -13}})}),
  Icon(graphics = {Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {-3, -3}, lineColor = {0, 0, 255}, extent = {{-67, 35}, {67, -35}}, textString = "DFIG")}));
    end DFIG;
    package Interfaces
      extends Modelica.Icons.InterfacesPackage;
...
record DWTData
  ...
  parameter Units.PerUnit Qgref = 0 "Reference of reactive power" annotation(
    Dialog(group = "Reference data"));
  // Lookup table data:
  parameter String tableNameR2="omega" "Table name on file or in function usertab" annotation (Dialog(group="Lookup table definition"));
  parameter String fileNameR2="NoName" "File where matrix is stored" 
  annotation (Dialog(
      group="Lookup table definition",
      loadSelector(filter="MATLAB MAT-files (*.mat)",
          caption="Open file in which table is present")));
  parameter String tableNameR4="beta" "Table name on file or in function usertab" annotation (Dialog(group="Lookup table definition"));
  parameter String fileNameR4="NoName" "File where matrix is stored" 
  annotation (Dialog(
      group="Lookup table definition",
      loadSelector(filter="MATLAB MAT-files (*.mat)",
          caption="Open file in which table is present")));
  ...
  annotation(
    ...
    package TURBINA_model
      ...
      function CP
        extends Modelica.Icons.FunctionsPackage;
        input Real Wtur "Velocidade mecânica da turbina";
        input Real Vw "Velocidade do vento";
      ...
      model EOLICA
        ...
        parameter Real Wrmb = 60 * pi annotation(
          Dialog(group = "Base Data"));
        // Parâmetros do sistema aerodinâmico:
        ...
        OmniPES.Units.PerUnit Ttur, Ptur, Wtur;
        Real cp "%";
...
// Obtendo o conjugado da turbina:
      ...
      model DUASMASSAS
        ...
        Modelica.Mechanics.Rotational.Components.Inertia inertia_maq(J = 2 * Hm) annotation(
          Placement(visible = true, transformation(origin = {30, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.Rotational.Components.SpringDamper eixo(c = Ktm, d = Dtm) annotation(
          Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.Rotational.Interfaces.Flange_a flange_tur annotation(
          Placement(visible = true, transformation(origin = {-60, 16}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.Rotational.Interfaces.Flange_b flange_maq annotation(
          Placement(visible = true, transformation(origin = {60, 16}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      initial equation
        der(eixo.flange_a.phi - eixo.flange_b.phi) = 0;
      equation
        connect(flange_tur, inertia_tur.flange_a) annotation(
          Line(points = {{-60, 16}, {-60, 0}, {-40, 0}}));
        connect(inertia_tur.flange_b, eixo.flange_a) annotation(
          Line(points = {{-20, 0}, {-10, 0}}));
        connect(eixo.flange_b, inertia_maq.flange_a) annotation(
          Line(points = {{10, 0}, {20, 0}}));
        connect(inertia_maq.flange_b, flange_maq) annotation(
          Line(points = {{40, 0}, {60, 0}, {60, 16}}));
        annotation(
          Icon(graphics = {Rectangle(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, extent = {{-100, 40}, {100, -40}}), Rectangle( lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-40, 2}, {40, -2}}), Rectangle(origin = {-60, 0}, lineColor = {0, 0, 255}, extent = {{-20, 20}, {20, -20}}), Rectangle(origin = {60, 0}, lineColor = {0, 0, 255}, extent = {{-20, 10}, {20, -10}})}));
      end DUASMASSAS;
    end TURBINA_model;
    ...
    package DFIG_model
      ...
      model MIT
        ...
        OmniPES.Circuit.Interfaces.PositivePin pin_estator annotation(
        ...
        OmniPES.Circuit.Interfaces.NegativePin pin_rotor annotation(
    ...
    package CONVERSOR_model
      ...
      model CONVERSOR
        ...
        parameter Units.PerUnit Ceq = 35.897 "Capacitor of conversor" annotation(
          Dialog(group = "Conversor Data"));
        // Variáveis e interfaces do conversor:
        OmniPES.Units.PerUnit Pcc_RSC, Pcc_GSC;
      ...
      initial equation
        der(capacitor.v) = 0;
      equation
// Obtendo as potências das fontes CA:
    ...
    package CONTROL_model
      ...
      package Funcoes
        ...
        equation
          ...
          annotation(
            Diagram,
            Icon(graphics = {Rectangle(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Line(points = {{-100, -100}, {100, 100}, {100, 100}}, color = {0, 0, 255}), Text(origin = {-26, 69}, lineColor = {0, 0, 255}, extent = {{-76, 21}, {76, -21}}, textString = "qd"), Text(origin = {27, -57}, lineColor = {0, 0, 255}, extent = {{-73, 19}, {73, -19}}, textString = "ReIm")}));
        end T;
...
/*absU = absC(u1.y);
      ...
      model PLL
        ...
        OmniPES.WindTurbine.CONTROL_model.Funcoes.T park annotation(
      ...
      model CTRL_MAQ
        ...
        OmniPES.WindTurbine.CONTROL_model.Funcoes.PI_ASTROM regW(ki = kiWrm, kp = kpWrm) annotation(
          Placement(visible = true, transformation(origin = {-90, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.PI_ASTROM regIqr(ki = kiIqr, kp = kpIqr) annotation(
        ...
        OmniPES.WindTurbine.CONTROL_model.Funcoes.iT ipark annotation(
        ...
        OmniPES.WindTurbine.CONTROL_model.Funcoes.PI_ASTROM regIdr(ki = kiIdr, kp = kpIdr) annotation(
          Placement(visible = true, transformation(origin = {-16, 30}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.PI_ASTROM regQ(ki = kiQs, kp = 0) annotation(
          Placement(visible = true, transformation(origin = {-90, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.FControl_TeIqr fControl_TeIqr(Lm = Lm, Ls = Ls) annotation(
          Placement(visible = true, transformation(origin = {-64, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.FControl_QsIdr fControl_QsIdr(Lm = Lm, Ls = Ls) annotation(
          Placement(visible = true, transformation(origin = {-64, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.FControl_UqrVqr fControl_UqrVqr(Kc = Kc, Lm = Lm, Lr = Lr, Ls = Ls) annotation(
          Placement(visible = true, transformation(origin = {10, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.FControl_UdrVdr fControl_UdrVdr(Kc = Kc, Lm = Lm, Lr = Lr, Ls = Ls) annotation(
          Placement(visible = true, transformation(origin = {10, 30}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.T park1 annotation(
          Placement(visible = true, transformation(origin = {40, 130}, extent = {{-10, 10}, {10, -10}}, rotation = 180)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.PI_ASTROM regIdg(ki = kiIdg, kp = kpIdg) annotation(
        ...
        OmniPES.WindTurbine.CONTROL_model.Funcoes.PI_ASTROM regIqg(ki = kiIqg, kp = kpIqg) annotation(
          Placement(visible = true, transformation(origin = {-18, -30}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.PI_ASTROM pi_astrom3(ki = kiVcc, kp = kpVcc) annotation(
          Placement(visible = true, transformation(origin = {-64, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.iT ipark1 annotation(
        ...
        OmniPES.WindTurbine.CONTROL_model.Funcoes.LIMITER limiter1(maxMod = 1) annotation(
          Placement(visible = true, transformation(origin = {-40, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.LIMITER limiter2 annotation(
          Placement(visible = true, transformation(origin = {34, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.LIMITER limiter3(maxMod = 1) annotation(
          Placement(visible = true, transformation(origin = {-40, -54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.FControl_UqgVqg fControl_UqgVqg(Kc = Kc) annotation(
          Placement(visible = true, transformation(origin = {8, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.FControl_UdgVdg fControl_UdgVdg(Kc = Kc) annotation(
          Placement(visible = true, transformation(origin = {8, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        OmniPES.WindTurbine.CONTROL_model.Funcoes.LIMITER limiter4 annotation(
...
// S:
  ...
  parameter OmniPES.WindTurbine.Interfaces.DWTData smData(MVAs = data.Sbase, Wb = data.wb, fileNameR2 = "/home/uemura/MYCODE/SBSE/Uemura2023SBSE/LookupTables/omegaR2.mat", fileNameR4 = "/home/uemura/MYCODE/SBSE/Uemura2023SBSE/LookupTables/betaR4.mat")  annotation(
  ...
  connect(dfig.pin_DFIG, voltageSource.p) annotation(
      ...
      DFIG dfig(smData = smData)  annotation(
          Placement(visible = true, transformation(origin = {0, 16}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      parameter OmniPES.WindTurbine.Interfaces.DWTData smData(MVAs = data.Sbase, Qgref = -0.5, Wb = data.wb, fileNameR2 = "/home/uemura/MYCODE/SBSE/Uemura2023SBSE/LookupTables/omegaR2.mat", fileNameR4 = "/home/uemura/MYCODE/SBSE/Uemura2023SBSE/LookupTables/betaR4.mat")  annotation(
          Placement(visible = true, transformation(origin = {-10, 42}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
